    ...
    <div className="bg-[#eceef1]">
      ...
      <button
        ...
        className={`md:hidden fixed left-4 z-50 w-10 h-10 bg-[#eceef1] rounded-full
          shadow-2xl flex items-center justify-center text-[#333f48] hover:text-[#b9975b]
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center">
            <motion.h1
              ...
              initial="hidden"
              animate="show"
              className="font-racingSansOne text-4xl md:text-6xl text-[#eceef1] font-medium mb-4"
            >
              Urheiluhieroja
            </motion.h1>
            <motion.p
              ...
              initial="hidden"
              animate="show"
              className="font-oswaldVariable text-[#eceef1] text-lg md:text-xl mb-8 max-w-xl"
            >
            ...
            >
              <button
                ...
                className="flex items-center gap-3 bg-[#b9975b] hover:bg-[#333f48] text-[#eceef1]
                  font-oswaldVariable font-medium text-lg md:text-xl
                  px-8 py-4 rounded-lg shadow-2xl
                  transition-all duration-300 hover:scale-105 hover:shadow-[#b9975b]/40"
              >
      ...
      {/* ====================================
          HOW IT WORKS
          ==================================== */}
      <section className="py-16 bg-[#333f48]">
        <div className="container mx-auto px-4">
          <motion.h2
            variants={fadeUp(0.1)}
            initial="hidden"
            whileInView="show"
            className="font-racingSansOne text-3xl md:text-4xl text-[#eceef1] text-center mb-12"
          >
            Näin se toimii
          </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {steps.map((step, i) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-[#eceef1] flex items-center justify-center text-[#b9975b] mb-4 shadow-lg">
                  {step.icon}
                </div>
                <span className="font-oswaldVariable text-[#eceef1] text-sm font-bold tracking-widest mb-1">
                  VAIHE {step.number}
                </span>
                <h3 className="font-racingSansOne text-[#eceef1] text-xl mb-2">{step.title}</h3>
                <p className="font-oswaldVariable text-[#eceef1]/70 text-sm leading-relaxed">
                  {step.desc}
                </p>
              </motion.div>
            ))}
      ...
      {/* ====================================
          SERVICES & PRICES
          ==================================== */}
      <section className="py-16 bg-[#eceef1]">
        <div className="container mx-auto px-4">
          <motion.h2
            variants={fadeUp(0.1)}
            initial="hidden"
            whileInView="show"
            className="font-racingSansOne text-3xl md:text-4xl text-[#333f48] text-center mb-4"
          >
            Palvelut ja hinnat
          </motion.h2>
          <motion.p
            ...
            {services.map((service, i) => (
              <motion.div
                ...
                className={`relative p-6 rounded-xl border shadow-lg transition-shadow hover:shadow-xl
                  ${service.highlight
                    ? 'bg-[#b9975b] text-[#eceef1] border-[#b9975b]'
                    : 'bg-[#eceef1] text-[#333f48] border-[#b9975b]/30'
                  }`}
              >
                {service.tag && (
                ...
                <div className={`mb-4 ${service.highlight ? 'text-[#eceef1]' : 'text-[#b9975b]'}`}>
                  {service.icon}
                </div>

                <h3 className={`font-racingSansOne text-xl mb-2 ${service.highlight ? 'text-[#eceef1]' : 'text-[#333f48]'}`}>
                  {service.title}
                </h3>

                <p className={`font-oswaldVariable text-sm leading-relaxed mb-4
                  ${service.highlight ? 'text-[#eceef1]/85' : 'text-gray-500'}`}>
                  {service.desc}
                </p>

                <div className={`font-oswaldVariable text-2xl font-bold
                  ${service.highlight ? 'text-[#eceef1]' : 'text-[#b9975b]'}`}>
                  {service.price}
                </div>
              </motion.div>
            ))}
      ...
      {/* ====================================
          GALLERY
          ==================================== */}
      <section className="py-16 bg-[#333f48]/10">
        <div className="container mx-auto px-4">
          <motion.h2
            variants={fadeUp(0.1)}
            initial="hidden"
            whileInView="show"
            className="font-racingSansOne text-3xl md:text-4xl text-[#333f48] font-medium text-center mb-12"
          >
            Hierontatilamme
          </motion.h2>
      ...
      {/* ====================================
          BOTTOM CTA
          ==================================== */}
      <section className="py-16 bg-[#b9975b]">
        <div className="container mx-auto px-4">
          <motion.div
            variants={fadeUp(0.1)}
            initial="hidden"
          ...
          >
            <h2 className="font-racingSansOne text-3xl md:text-4xl text-[#eceef1] mb-4">
              Valmis rentoutumaan ja palautumaan?
            </h2>
            <p className="font-oswaldVariable text-[#eceef1]/85 text-lg mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => navigate('/booking')}
                className="flex items-center justify-center gap-2 bg-[#eceef1] text-[#b9975b]
                  font-oswaldVariable font-bold text-lg px-8 py-4 rounded-lg
                  hover:bg-[#333f48] hover:text-[#eceef1] transition-all duration-300 shadow-lg"
              >
                <FaCalendarAlt />
                Varaa hierontaaika
              </button>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 bg-transparent border-2 border-[#eceef1] text-[#eceef1]
                  font-oswaldVariable font-semibold text-lg px-8 py-4 rounded-lg
                  hover:bg-[#eceef1] hover:text-[#b9975b] transition-all duration-300"
              >
                <FaPhone />
                +358 50 123 4567
              </a>
            ...
            <p className="font-oswaldVariable text-[#eceef1]/70 text-sm mt-6">
